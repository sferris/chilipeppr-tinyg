...
cprequire_test(["inline:net-virtualsmf-chilipeppr-tinyg"], function(ws) {
...
cpdefine("inline:net-virtualsmf-chilipeppr-tinyg", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "net-virtualsmf-chilipeppr-tinyg", // Make the id the same as the cpdefine id
